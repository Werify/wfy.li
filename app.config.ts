...
export default defineAppConfig({
  config: {
    ...
    footer: {
      ...
      darkLogo: "test",
      hideEmailBox: false,
      emailAPI: "https://api.test.net/api/Email/ContactUs",
      copyRight: `<span>© 2022-2023
                            <a href="https://test.net" class="hover:underline">test</a>.
      ...
      socials: [
        ...
        {
          icon: "mdi:linkedin",
          link: "https://www.linkedin.com/company/test",
        },
        {
          icon: "mdi:youtube",
      ...
      footerLinks: [
        ...
        },
        {
          ...
          links: [
            ...
            { title: "More from test", link: "https://test.net/products", target: "_blank"},
          ],
        },
      ],
    } as IFooter,
